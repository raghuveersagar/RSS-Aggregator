...
If you like some websites and keep on checking to see some thing new has been updated.
So you have keep to track of all websites and visit them to check if they have any new stories.

Instead of you checking again and again it would be nice if the website told you that it has something new.
Websites have files called RSS feeds ,which the user can subscribe, and whenever there is a new story website updates the feed file.
